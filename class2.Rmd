---
title: "Class 2: Data frames, measures of central tendency, measures of dispersion, and distributions"
...
# Print out the =last= 6 rows of dataSet
...
test_object("dataSet")
test_output_contains("tail(dataSet)", incorrect_msg = "Make sure to print the last six rows!")
success_msg("Great!")
```
...
test_output_contains("glimpse(dataSet)", incorrect_msg = "Make sure to print a glimpse of the dataSet.")
test_output_contains("library(dplyr)", incorrect_msg = "Make sure to load the dplyr package!")
success_msg("Great!")
```
...
test_output_contains("lowFrequency <- dataSet[dataSet$Freq <= 30, ]", incorrect_msg = "Make sure to make a new dataframe 'lowFrequency'")
...
test_output_contains("dataSet$FreqByTwo <- dataSet$Freq/2", incorrect_msg = "Make sure to create the FreqByTwo variable!")
...
```{r ex="Freq", type="pre-exercise-code"}
library(readr)
```
...
# The object dataSet is already in your workspace
# Compare the mean of Freq. 

# Compare the median of Freq. 

# Are they close together numerically? Assign the answer (yes|no) as a string to the variable 'answer'
```
...
test_output_contains("median(dataSet$Freq, na.rm=TRUE)", incorrect_msg = "Make sure to add 'na.rm=TRUE' to your 'median' code!")
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. The mean is more than 10 higher than the median.")
```
...
# Does the plot have a bell shape? Assign the answer (yes|no) as a string to the variable 'answer'
```
...
test_output_contains("library(ggplot2)", incorrect_msg = "Make sure you load ggplot2 first!")
test_output_contains('ggplot(dataSet, aes(x=Freq))  + geom_line(stat="density") + geom_vline(aes(xintercept=mean(dataSet$Freq)), color="red")', incorrect_msg = "Don't forget to add the red line!")
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. The plot does not look like a bell shape.")
```
...
# Does the plot support that the variable is normally distributed? Assign the answer (yes|no) as a string to the variable 'answer'
```
...
test_output_contains("qqnorm(dataSet$Freq)", incorrect_msg = "Make sure you draw the qqplot!")
test_output_contains('qqline(dataSet$Freq)', incorrect_msg = "Don't forget to add the qqline!")
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. The plot does not support that the data is normally distributed.")
```
...
# Does the test support that the variable is normally distributed? Assign the answer (yes|no) as a string to the variable 'answer'
```
...
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. p < 0.05, so we can assume that the data is not normally distributed")
```
...
# The object dataSet is already in your workspace
# Compare the mean of Mean_RT. 

# Compare the median of Mean_RT. 
...
test_output_contains("library(ggplot2)", incorrect_msg = "Make sure you load ggplot2 first!")
test_output_contains('ggplot(dataSet, aes(x=Mean_RT))  + geom_line(stat="density") + geom_vline(aes(xintercept=mean(dataSet$Mean_RT)), color="red")', incorrect_msg = "Don't forget to add the red line!")
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. The plot does not look like a bell shape.")
```
...
test_output_contains("qqnorm(dataSet$Mean_RT)", incorrect_msg = "Make sure you draw the qqplot!")
test_output_contains('qqline(dataSet$Mean_RT)', incorrect_msg = "Don't forget to add the qqline!")
test_output_contains('answer<-"no"', incorrect_msg = "Correct answer: No. The plot does not support that the data is normally distributed.")
```
...
test_output_contains("ibrary(ggplot2)", incorrect_msg = "Don't forget to load ggplot2")
test_output_contains('ggplot(dataSet, aes(x=1, y=Freq)) + geom_boxplot()', incorrect_msg = "Make sure you draw the boxplot!")
```
...
test_output_contains("ibrary(ggplot2)", incorrect_msg = "Don't forget to load ggplot2")
test_output_contains('ggplot(dataSet, aes(x=1, y=Mean_RT)) + geom_boxplot()', incorrect_msg = "Make sure you draw the boxplot!")
```
