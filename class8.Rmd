...
# https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_Berry_2018.csv
...
# Load the course data from the course website to the object 'dataSet':
# https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_Berry_2018.csv
dataSet <- read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_Berry_2018.csv")
# Load the dplyr package
library(dplyr)
# Print a 'glimpse' of the dataSet
glimpse(dataSet)
...
durbinWatsonTest<-function(mod) {
 read_rds(gzcon(url("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_durbinWatson.rds")))
} 
...
boots<-suppressMessages(as.data.frame(read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_bootstraps.csv")))
return(boots)
}
mod<-"mod"
```
...
#This is a hack, it reads pre-defined bootstrap data from the server, to avoid that (1) the scripts runs longer than 80 seconds, the datacamp light limit and (2) that students have to wait a long time for their results
bootstrap <- function(model) {
boots<-read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class8_bootstraps.csv")
return(boots)
}
