...
library(dplyr)
library(readr)
dataSet<-read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/datasets/class10_Bresnan_et_al_2017.csv")
...
# https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class11_Berry_2018.csv
...
# Load the course data from the course website to the object 'dataSet':
# https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class11_Berry_2018.csv
dataSet <- read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/datasets/class11_Berry_2018.csv")
# Load the dplyr package
library(dplyr)
# Convert all character values to factor
dataSet <- dataSet %>% 
...
confint<-function(model, method, boot.type, nsim, parallel, ncpus) {
  suppressWarnings(suppressMessages(as.data.frame(read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class11_Berry_2018_confints_model_1.csv"))))
}
```
...
confint<-function(model, method, boot.type, nsim, parallel, ncpus) {
  suppressWarnings(suppressMessages(as.data.frame(read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class11_Berry_2018_confints_model_2.csv"))))
}
```
...
# Load the course data from the course website to the object 'dataSet':
# https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/datasets/class10_Bresnan_et_al_2017.csv
...
# Load the course data from the course website to the object 'dataSet':
#https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/datasets/class10_Bresnan_et_al_2017.csv
dataSet<-read_csv("https://github.com/jeroenclaes/statistics_for_linguistics/blob/master/datasets/class10_Bresnan_et_al_2017.csv")
# Load the dplyr package
library(dplyr)
# Convert all character values to Factor with `mutate_if`
...
library(lme4)
confint<-function(model, method, boot.type, nsim, parallel, ncpus) {
  suppressWarnings(suppressMessages(as.data.frame(read_csv("https://raw.githubusercontent.com/jeroenclaes/statistics_for_linguistics/master/class11_Bresnan_et_al_2017_confints_model.csv"))))
}
```
